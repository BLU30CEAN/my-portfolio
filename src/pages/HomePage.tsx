          ...
          >
            ...
            <ProjectContent>
              ...
              >
                    ...
                    <ProjectDescription>
                      HeyGen·LiveAvatar 등 실시간 AI 아바타 API와 연동해 STT → LLM(GPT-4o-mini/Claude 등) → TTS(ElevenLabs)·립싱크까지 오케스트레이션했습니다. UX 패턴은 채팅·음성과 동일 계열의 이벤트 처리에, 미디어는 화상통화와 맞닿은 WebRTC(WebSocket 오디오 포함) 흐름으로 구성했습니다.
                    </ProjectDescription>
                    <ProjectTech>
